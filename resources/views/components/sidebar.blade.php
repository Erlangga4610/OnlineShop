 <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Nothing <sup>2</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">All Item</h6>
                        <a class="collapse-item" href="{{ route('products') }}">
                            <i class="fas fa-box-open me-2 text-primary"></i> Product
                        </a>
                        <a class="collapse-item" href="{{ route('brands') }}">
                            <i class="fas fa-tags me-2 text-success"></i> Brand
                        </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseRoles" class="collapse" aria-labelledby="headingRoles" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="permission">
                            <i class="fas fa-key me-2 text-warning"></i> Permissions
                        </a>
                        <a class="collapse-item" href="role-permission">
                            <i class="fas fa-user-tag me-2 text-info"></i> Roles Permissions
                        </a>
                        <a class="collapse-item" href="user-role">
                            <i class="fas fa-users-cog me-2 text-success"></i> User Roles
                        </a>
                    </div>
                </div>
            </li>
