<div>
    ...
    <h1 class="h3 mb-2 text-gray-800">Data Brands</h1>
                ...
                <tbody>
                    @forelse ($brands as $b)
                        <tr>
                            ...
                            <td>
                                @can('edit-brands')
                                    <button wire:click="edit({{ $b->id }})" class="btn btn-sm btn-outline-warning" data-bs-toggle="modal" data-bs-target="#formModal">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                @endcan
                                @can('delete-brands')
                                    <button wire:click="confirmDelete({{ $b->id }})" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">
    ...
    document.addEventListener('livewire:init', () => {
        // Tutup modal ketika event dikirim dari backend
